...
class AccountManagementAnalyzer:
    ...
    def preprocessing_and_analysis(self):
      ...
      sns.barplot(y=top_narrations.index, x=top_narrations.values, hue=top_narrations.index, legend=False, palette="coolwarm")
      ...
      plt.figure(figsize=(10, 6))
      ax = sns.barplot(y=top_narrations.index, x=top_narrations.values, hue=top_narrations.index, legend=False, palette="coolwarm")
